...
\begin{definition}[Upper and Lower Integrals]
    ...
    \[
        \upperI \para{f} = \inf_{\partition\text{ is a partition of }\ccintv{a}{b}} \upperSum \para{f, \partition}
    \]
    be the \emph{upper integral} of \(f\), and similarly,
    \[
        \lowerI \para{f} = \sup_{\partition\text{ is a partition of }\ccintv{a}{b}} \lowerSum \para{f, \partition}
    \]
